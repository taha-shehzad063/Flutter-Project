      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(children: [
              _circleBtn(onTap: Get.back, child: const Icon(Icons.arrow_back_ios_new, size: 20)),
              const SizedBox(width: 16),
              const Text('Details', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
            ]),
          ),
            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    height: 220,
                    decoration: BoxDecoration(color: _peach, borderRadius: BorderRadius.circular(24)),
                    child: Stack(children: [
                      Center(
                        child: Image.asset('assets/icons/pizzaimage.png', height: 190, width: 190, fit: BoxFit.contain),
                      ),
                      // Heart – bottom right of image card
                      Positioned(
                        right: 16, bottom: 16,
                        child: Obx(() => _circleBtn(
                          onTap: c.toggleFavorite,
                          child: Icon(
                            c.isFavorite.value ? Icons.favorite : Icons.favorite_border,
                            size: 20,
                            color: c.isFavorite.value ? _orange : Colors.grey,
                          ),
                        )),
                      ),
                    ]),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          Container(
                            ...
                            child: const Center(child: Icon(Icons.store, size: 16, color: _orange)),
                          ),
                          const SizedBox(width: 8),
                          const Text('Uttora Coffee House', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                        ]),
                      ),
                      ...
                      Row(children: [
                        ...
                        _infoChip(Icons.electric_bike_outlined, 'Free', _orange),
                        const SizedBox(width: 14),
                        _infoChip(Icons.access_time_rounded, '20 min', Colors.grey),
                      ]),
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: Obx(() => Row(
                            children: List.generate(sizes.length, (i) => _sizeChip(
                              label: sizes[i],
      ...
      child: Center(
        child: Icon(icon, size: 24, color: _orange),
          ...
          Container(
            ...
            child: Row(children: [
              const Text(r'$32', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800)),
              const Spacer(),
              Container(
                height: 54,
